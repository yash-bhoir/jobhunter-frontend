...
const PLANS = [
  {
    ...
    features: [
      ...
      '10 jobs per search result',
      '15 job platforms (Indeed, Naukri, RemoteOK…)',
      '10 outreach emails / month',
      'Pattern-guessed HR email formats',
      'Basic job match scoring',
      '7-day search history',
    ],
    disabled: [
      'Hunter.io verified HR emails',
      'AI email generation',
      'Resume AI parsing & ATS optimise',
      'Deep job evaluation (A–F scoring)',
      'Interview prep generator',
      'Excel / PDF export',
      'JSearch (LinkedIn + Naukri aggregated)',
      'LinkedIn auto job alerts',
  ...
  },
  {
    ...
    features: [
      ...
      '30 jobs per search result',
      'All 19 platforms + JSearch aggregator',
      'Unlimited outreach emails',
      'Hunter.io verified HR emails (50 / mo)',
      'AI-powered personalised email generation',
      'Resume AI parsing & ATS keyword optimise',
      'Deep job evaluation with A–F scoring',
      'Interview prep question generator',
      'Excel + PDF export',
      'LinkedIn auto job alerts (hourly)',
      'Career page scanner — 80+ top companies',
  ...
  },
  {
    ...
    features: [
      ...
      'Everything in Pro',
      'Up to 10 user seats',
      '200 verified HR email lookups / month',
      '100 LinkedIn profile lookups / month',
      '+100 grace credits if you hit 0 mid-month',
      'White-label PDF reports',
      'Admin candidate management dashboard',
      'Read-only API access',
      'Priority email support',
      '1-year full search history',
    ],
  },
];
